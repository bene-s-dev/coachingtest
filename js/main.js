      ...
      : [
          {
            ...
            role: "Klientin",
            rating: 5,
            text: "Ich kann die Zusammenarbeit mit Sarah unbedingt empfehlen 💗\n\nDie Auswahl der Methoden, eine Begleitung auf Augenhöhe, ein gemeinsamer Prozess, das Finden guter Lösungen.\n\nSarah hat die Fähigkeit zu Wertschätzung und Empathie, auch deswegen konnte ich Perspektiven dazugewinnen und konkrete Fortschritte erkennen.\n\nIch freue mich schon auf eine nächste Zusammenarbeit 🥂❗"
          },
          {
      ...
      reviews.forEach(function (rev, idx) {
        ...
        slide.innerHTML = `
          <div class="review-card">
            ...
            <p class="review-text">${rev.text.replace(/</g, '&lt;').replace(/>/g, '&gt;')}</p>
